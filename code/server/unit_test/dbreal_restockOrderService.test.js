...
describe('Restock Order Service - DB test', () => {
    ...
    const product1 = new Product(1, 10, "product 1", 9.99, 24); // 
    const product2 = new Product(2, 10, "product 2", 13.99, 43); // 
    const product3 = new Product(2, 10, "product 3", 16.99, 55); // 
    const product4 = new Product(3, 10, "product 4", 110.99, 18); // 
    const product5 = new Product(undefined, 10, "product 5", 12.99, 96); // SKUId is undefined --> insertion in SKUtoRestockTable will fail (NOT NULL CONSTRAINT FAILED)
    const product6 = new Product(3, 10, "product 6", 6.99, 67); // SAME SKUId of product4 --> insertion in SKUtoRestockTable will fail if executed with same RESTOCKId (PRIMARY KEYS CONSTRAINT FAILED)
    // 	constructor(RFID, SKUId) 
    const item1 = new Sku_Item_RestockOrder(1, 10, "12345678901234567890123456789011");
    const item2 = new Sku_Item_RestockOrder(2, 10, "12345678901234567890123456789012");
    const item3 = new Sku_Item_RestockOrder(2, 10, "12345678901234567890123456789013");
    const item4 = new Sku_Item_RestockOrder(3, 10, "12345678901234567890123456789014");
    const item5 = new Sku_Item_RestockOrder(undefined, 10, "12345678901234567890123456789015"); // SKUId is undefined --> insertion in SKUItemtoRestockTable will fail (NOT NULL CONSTRAINT FAILED)
    const item6 = new Sku_Item_RestockOrder(3, 10, "12345678901234567890123456789014"); // SAME rfid as item4 --> insertion in SKUItemtoRestockTable will fail if executed with same RESTOCKId (NOT NULL CONSTRAINT FAILED) 
