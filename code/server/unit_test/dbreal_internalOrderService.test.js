...
const Product_SkuItemInternal = require('../models/Product_SkuItemInternal');
const Product_Internal = require('../models/Product_Internal');
...
describe('Internal Order Service - DB test', () => {
    ...
    testCreateSkuItemToInternal(new Product_SkuItemInternal('12', "a product1", 11.99, '12345678901234567890123456789016'), 1, 1);
    testCreateSkuItemToInternal(new Product_SkuItemInternal('13', "a product2", 4.99, '12345678901234567890123456789017'), 2, 2);
    testCreateSkuItemToInternal(new Product_SkuItemInternal('14', "a product3", 5.99, '12345678901234567890123456789018'), 3, 3);
    testCreateSkuItemToInternal(new Product_SkuItemInternal('2', "a product4", undefined, '12345678901234567890123456789019'), 4, 4);

    testAddSkuItemToSkuInternalTable(new Product_Internal("12", "a product1", 11.99, 2), 1, 1);
    testAddSkuItemToSkuInternalTable(new Product_Internal("13", "a product2", 4.99, 5), 2, 2);
    testAddSkuItemToSkuInternalTable(new Product_Internal("14", "a product3", 5.99, 7), 3, 3);
    testAddSkuItemToSkuInternalTable(new Product_Internal(undefined, "a product4", 10.45, 6), 4, 4);
