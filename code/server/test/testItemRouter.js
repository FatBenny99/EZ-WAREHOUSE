...
describe("Test Item Api", () => {
    ...
    getItemByIDAndSupplierId(200, 1, "an item", 41.24, 1, 2);
    ...
    getItemByIDAndSupplierId(404, 4, "an item", 41.24, 1, 2);
...
function getItemByIDAndSupplierId(expectedHTTPStatus, id, description, price, SKUId, supplierId) {

    it("getting a Item by ID and supplierId", function (done) {
        if (expectedHTTPStatus === 200) {
            ...
            agent.post("/api/item")
                ...
                .then(function (res) {
                    res.should.have.status(201);
                    agent.get("/api/items/" + id + "/" + supplierId).then(function (r2) {
