...
describe("Test InternalOrder Api", () => {
    ...
    //HAPPY
    newInternalOrder(201, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1);
    updateInternalOrderState(200, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    ...
    getInternalOrderList(200, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1,
        2, "2021/11/30 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    ...
    getInternalOrderIssued(200, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1,
        2, "2021/11/30 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
        { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1);
    getInternalOrderAccepted(200, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1,
        2, "2021/11/30 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
        { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1, "ACCEPTED");
    getInternalOrderByID(200, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1)
    deleteInternalOrder(204, 1, "2021/11/29 09:33", [{ "SKUId": 1, "description": "a product", "price": 11.99, "qty": 3 },
    { "SKUId": 2, "description": "another product", "price": 11.99, "qty": 3 }], 1);
