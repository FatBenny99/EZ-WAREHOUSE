...
describe("Test RestockOrder Api", () => {
    ...
    beforeEach(async () => {
        ...
        await skuDB.createSku(new Sku(1, "a sku", 40, 50, "prova", 52, 12.49));
        await itemDB.createItem(new Item(10, "item", 10.99, 1, 1))
    });

    //HAPPY
    newRestockOrder(201, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1)
    updateRestockOrderState(200, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, "DELIVERED");
    updateRestockOrderTransportNote(200, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, { "deliveryDate": "2021/12/29" })
    updateRestockOrderSkuItems(200, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, [{ "SKUId": 12, "itemId": 10, "rfid": "12345678901234567890123456789016" }, { "SKUId": 12, "itemId": 10, "rfid": "12345678901234567890123456789017" }]);
    getRestockOrderList(200, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1,
        "2021/11/30 09:40", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1)
    getRestockOrderIssued(200, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1,
        "2021/11/30 09:40", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1)
    getRestockOrderByID(200, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1);
    deleteRestockOrder(204, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1);


    //WRONG
    newRestockOrder(422, undefined, [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1)
    newRestockOrder(422, "2021/11/29 09:33", undefined, 1);
    newRestockOrder(422, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], undefined);
    updateRestockOrderState(404, 5, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, "DELIVERED");
    updateRestockOrderState(422, 5, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, undefined);
    updateRestockOrderTransportNote(404, 5, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, { "deliveryDate": "2021/12/29" })
    updateRestockOrderTransportNote(422, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, undefined);
    updateRestockOrderSkuItems(404, 5, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, [{ "SKUId": 12, "itemId": 10, "rfid": "12345678901234567890123456789016" }, { "SKUId": 12, "itemId": 10, "rfid": "12345678901234567890123456789017" }]);
    updateRestockOrderSkuItems(422, 1, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 },
    { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1, undefined);
    deleteRestockOrder(404, 5, "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1);
    deleteRestockOrder(422, "a5", "2021/11/29 09:33", [{ "SKUId": 12, "itemId": 10, "description": "a product", "price": 10.99, "qty": 30 }, { "SKUId": 180, "itemId": 10, "description": "another product", "price": 11.99, "qty": 20 }], 1);
