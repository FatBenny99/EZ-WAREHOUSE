...
class Database {
    ...
    createRestockSupportTableforItemTable() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const sql = "CREATE TABLE IF NOT EXISTS SkuItemToRestock(SKUId INTEGER NOT NULL,ItemID INTEGER NOT NULL,RFID TEXT NOT NULL, restockID INTEGER NOT NULL, PRIMARY KEY (RFID,restockID) ON CONFLICT ROLLBACK,  FOREIGN KEY (restockID) REFERENCES RestockOrder(id) ON UPDATE CASCADE ON DELETE CASCADE)";
    ...
    createRestockSupportTableforSKUTable() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const sql = "CREATE TABLE IF NOT EXISTS SKUToRestock(SKUId INTEGER NOT NULL,itemId INTEGER NOT NULL, restockID INTEGER NOT NULL, description TEXT, price NUMERIC NOT NULL, qty NUMERIC NOT NULL, PRIMARY KEY (skuID,restockID) ON CONFLICT ROLLBACK, FOREIGN KEY (skuID) REFERENCES SKU(ID) ON UPDATE CASCADE ON DELETE CASCADE, FOREIGN KEY (restockID) REFERENCES RestockOrder(id) ON UPDATE CASCADE ON DELETE CASCADE)";
