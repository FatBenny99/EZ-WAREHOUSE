...
| ItemDB | db_item.test.js -> Item - DB test (testNewItem(), testGetItemList(), testGetSpecific(), testGetSpecific2(), testUpdateItemByIdAndSupplierId(), testDeleteItemByIdAndSupplierId()) |
...
| ItemService | dbreal_itemService.test.js -> Item Service - DB test (testNewItem(), testGetItemList(), testGetSpecific(), testGetSpecific2(), testUpdateItemByIdAndSupplierId(), testDeleteItemByIdAndSupplierId()) |
